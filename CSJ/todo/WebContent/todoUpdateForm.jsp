...
<body>
	...
	<form action="TodoUpdateServlet" method="post">
		아이디 : <input type="text" name="id" value="<%=todo.getId()%>" readonly="readonly"/><br>
		할것 : <input type="text" name="todo" value="<%=todo.getTodo()%>" /><br> 
		한것 : <input type="text" name="done" value="<%=todo.getDone()%>" /><br> 
